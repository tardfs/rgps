...
Здесь 
\begin{itemize}
\item {$\Delta\nabla\phi^{j,k}_{AB}$ - измеренная фазовая разность.}
...
\item {$\Delta\nabla N^{j,k}_{AB}$ - целочисленная (в циклах) фазовая разность не содержащая неоднозначности.}
\end{itemize}

Исходное уравнение наблюдения для процедуры \text{LAMBDA} \cite[стр.13, формула (2.1)]{Tiberius}:
\begin{equation}
y = Bb+Aa+e
\end{equation}
